    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" placeholder="Kode Kota" name="kode" id="kode">
          </div>

          <div class="form-group">
            <label>Is actived</label>
            <input type="number" class="form-control form-control-sm" placeholder="Is actived" name="is_actived" id="is_actived">
          </div>
          ...
          <div class="form-group">
            ...
            --->
            <?=is_select("kota","kota_id","id","name");?>
          </div>
